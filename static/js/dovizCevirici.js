      ...
      function makeConvert(){
        ...
        httpRequest.onload = function(){
          if (httpRequest.status === 200){
            ...
            document.querySelector(".response").innerHTML = result.toString().slice(0, 5) +" "+selector2;
          }}
        httpRequest.open('GET','http://api.exchangeratesapi.io/v1/latest?access_key=5e4c405f557feeffbbe7a6b6adbfcd92&format=1')
        httpRequest.send()
      }
